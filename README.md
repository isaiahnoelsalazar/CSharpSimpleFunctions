...
#### Step 2
- Go to "Browse" tab and search for "CSharpSimpleFunctions" and simply install the latest version

### In Visual Studio Package Manager Console
```
dotnet add package CSharpSimpleFunctions --version [latest release version]
```
